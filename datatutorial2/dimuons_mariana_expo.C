...
void dimuon::FitPeak() {
  ...
  TF1* f = new TF1("f",fitfun,_mmin,_mmax,nfitpar);
    //f->SetParameters(100,3.5,3.9,2,0);
   //f->SetParameters(100,3.2,5,2,0);
    f->SetParameters(100,3.2,5,2,0);
  hpeak->Fit("f");
  ...
  L.SetTextSize(0.03);
  L.DrawLatex(0.15,0.75,"resonance: #psi'");
